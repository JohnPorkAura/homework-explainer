...
DB_FILE      = "homework_explainer.db"
SYSTEM_PROMPT = "You are an expert Homework Explainer assistant. Enter any concept or homework question. Get a clear step-by-step explanation."

app = FastAPI(title="Homework Explainer")
...
<title>Homework Explainer</title>
...
<div id="auth-overlay">
  <div class="auth-box">
    <div class="auth-logo">Homework Explainer</div>
    <div class="auth-sub">Understand anything, explained simply</div>
    <div class="auth-tabs">
...
<header id="main-header" style="display:none">
  <div class="hdr-left">
    <div class="logo">Homework Explainer</div>
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Homework Explainer</em><br>Understand anything, explained simply</h1>
    <p>Enter any concept or homework question. Get a clear step-by-step explanation. Built for users.</p>
  </div>
  ...
  <div class="card" id="input-card">
    <div class="card-hd">
      ...
      <textarea id="field-subject" placeholder="Enter subject..." required></textarea>
    </div>
    <div class="field">
      <label for="field-grade_level">Grade Level</label>
      <select id="field-grade_level">
    ...
    <div class="field">
      <label for="field-question_or_concept">Question Or Concept</label>
      <input type="text" id="field-question_or_concept" placeholder="e.g. your question or concept">
    </div>
    <div class="btn-row">
  ...
  <footer>
    <div class="foot-note">Homework Explainer &middot; Powered by Groq llama-3.3-70b</div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Homework Explainer assistant. Enter any concept or homework question. Get a clear step-by-step explanation.",
  promptTemplate: "Subject: {{subject}}\\nGrade Level: {{grade_level}}\\nQuestion Or Concept: {{question_or_concept}}",
  resultFormat:   'steps', // text | list | steps
  resultConfig:   {"label": "Result", "copyable": true},
  inputs:         [{"id": "subject", "label": "Subject", "type": "textarea", "placeholder": "Enter subject...", "required": true}, {"id": "grade_level", "label": "Grade Level", "type": "select", "options": ["Elementary", "Middle School", "High School", "College"], "required": false}, {"id": "question_or_concept", "label": "Question Or Concept", "type": "text", "placeholder": "e.g. your question or concept", "required": false}],
};
...
@app.get("/api/health")
def health():
    return {"status": "ok", "app": "Homework Explainer", "ai_ready": bool(GROQ_API_KEY)}
